...
export default async function handler(req, res) {
    ...
    try {
        ...
        // STEP 1: Generate OAuth Token [5.2.1]
        ...
        // STEP 2: Call V2 Sandbox Status Check API securely [6.3.6]
        const statusUrl = `https://api-preprod.phonepe.com/apis/pg-sandbox/pg/checkout/v2/order/${cleanTxId}/status`;
