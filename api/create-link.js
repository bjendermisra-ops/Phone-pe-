...
export default async function handler(req, res) {
    ...
    try {
        ...
        // STEP 1: Generate OAuth Token securely from PhonePe Sandbox Identity Manager [5.2.1]
        const tokenUrl = "https://api-preprod.phonepe.com/apis/pg-sandbox/identity-manager/v1/oauth/token";
        ...
        // STEP 2: Create Payment Session using PhonePe V2 Sandbox Checkout API [5.1.2, 5.1.3]
        const payUrl = "https://api-preprod.phonepe.com/apis/pg-sandbox/pg/checkout/v2/pay";
