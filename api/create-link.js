...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Hardcoded Production Credentials for testing as requested
        ...
        // Success redirect points back to your vercel domain
        ...
        const requestPayload = {
            ...
            redirectMode: "POST", // FIXED: "REDIRECT" ko badal kar "POST" kiya hai!
        ...
        const phonePeUrl = "https://api.phonepe.com/apis/hermes/pg/v1/pay"; // Production endpoint
