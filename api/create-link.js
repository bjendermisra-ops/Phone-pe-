...
export default async function handler(req, res) {
    ...
    try {
        ...
        // STEP 1: Sandbox OAuth Token Generation (No 'identity-manager' inside URL in Sandbox)
        ...
        // STEP 2: Create Payment Session using Sandbox Checkout API (No 'pg/' inside URL in Sandbox)
